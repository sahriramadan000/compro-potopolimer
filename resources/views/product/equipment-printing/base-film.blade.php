            ...
            <div class="col-xl-8">
                <div class="service-details-content">
                    <div class="service-details-content-thumb mb-25">
                         <img src="{{ asset('assets/imgs/ppi-img/service/base-film/770 x 414 base film.png')}}" alt="image not found" class="img-fluid" style="max-height: 35vh !important;">
                    </div>
                    ...
                    <div class="middel-img d-flex">
                        <img src="{{ asset('assets/imgs/ppi-img/service/base-film/370x370 Base film.png')}}" alt="img not found" style="max-width: 35vh !important;">
                        <img src="{{ asset('assets/imgs/ppi-img/service/base-film/370x370 Base film 2.png')}}" alt="img not found" style="max-width: 35vh !important;">
                    </div>
